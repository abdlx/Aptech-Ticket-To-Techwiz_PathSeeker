...
export const contentIds = Object.freeze({
  workbook: deterministicId('7', 1),
  uxCourse: deterministicId('7', 2),
  analystVideo: deterministicId('7', 3),
})

export const storyIds = Object.freeze({ aisha: deterministicId('8', 1), daniel: deterministicId('8', 2) })
export const feedbackIds = Object.freeze({ sample: deterministicId('9', 1) })
