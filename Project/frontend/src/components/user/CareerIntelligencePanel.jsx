...
export default function CareerIntelligencePanel({ careerSlug, navigate }) {
  ...
  if (query.isLoading) return <section className="panel prose-card" aria-busy="true"><span className="eyebrow">Career intelligence</span><h2>Calculating your fit…</h2></section>
