...
Production screens use `src/services/pathseekerApi.js` for live Express API requests. `src/data.js` remains only as development/showcase fixture data and is not imported by production pages.
