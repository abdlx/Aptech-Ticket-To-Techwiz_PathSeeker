...
export function respondToIntent(text) {
  ...
  return match || { intent: 'help', reply: 'I can help you find careers, start the quiz, review matches, open resources, manage saved items, read stories, or update your profile.' }
}
