...
export const submitFeedback = asyncHandler(async (req, res) => {
  const { category, message, rating, context, contactConsent } = req.body
  ...
  const feedback = await feedbackService.submitFeedback(req.user.id, { category, message, rating, context, contactConsent })
