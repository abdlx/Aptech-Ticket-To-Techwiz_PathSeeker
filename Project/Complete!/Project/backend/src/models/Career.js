...
const careerSchema = new Schema(
  {
    ...
    traits: { type: [{ type: String, trim: true, maxlength: 60 }], default: [] },
    timeToJobReadyMinMonths: { type: Number, min: 0, max: 240 },
    timeToJobReadyMaxMonths: { type: Number, min: 0, max: 240 },
